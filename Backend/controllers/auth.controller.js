...
export const signup = async (req, res) => {
  try {
    ...
    if (existingUser) {
      ...
      // a user registration process where you check if a username is already taken before creating a new user.
    }
    ...
    const salt = await bcrypt.genSalt(10); //random value added to the password before hashing
